...
namespace Registro_Usuarios {
    ...
    public partial class UsuariosDataSet : global::System.Data.DataSet {
        ...
        public partial class DatosDataTable : global::System.Data.TypedTableBase<DatosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public DatosRow AddDatosRow(string ID, string Nombre, string Apellidos, int edad) {
...
namespace Registro_Usuarios.UsuariosDataSetTableAdapters {
    ...
    public partial class DatosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Datos] WHERE (([ID] = @Original_ID) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)) AND ((@IsNull_Apellidos = 1 AND [Apellidos] IS NULL) OR ([Apellidos] = @Original_Apellidos)) AND ((@IsNull_edad = 1 AND [edad] IS NULL) OR ([edad] = @Original_edad)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Datos] ([ID], [Nombre], [Apellidos], [edad]) VALUES (@ID, @Nom" +
                "bre, @Apellidos, @edad);\r\nSELECT ID, Nombre, Apellidos, edad FROM Datos WHERE (I" +
                "D = @ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Datos] SET [ID] = @ID, [Nombre] = @Nombre, [Apellidos] = @Apellidos, [edad] = @edad WHERE (([ID] = @Original_ID) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)) AND ((@IsNull_Apellidos = 1 AND [Apellidos] IS NULL) OR ([Apellidos] = @Original_Apellidos)) AND ((@IsNull_edad = 1 AND [edad] IS NULL) OR ([edad] = @Original_edad)));
SELECT ID, Nombre, Apellidos, edad FROM Datos WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Registro_Usuarios.Properties.Settings.Default.UsuariosConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Nombre, Apellidos, edad FROM dbo.Datos";
        ...
        public virtual int Fill(UsuariosDataSet.DatosDataTable dataTable) {
        ...
        public virtual UsuariosDataSet.DatosDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            UsuariosDataSet.DatosDataTable dataTable = new UsuariosDataSet.DatosDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(UsuariosDataSet.DatosDataTable dataTable) {
        ...
        public virtual int Delete(string Original_ID, string Original_Nombre, string Original_Apellidos, global::System.Nullable<int> Original_edad) {
            if ((Original_ID == null)) {
        ...
        public virtual int Insert(string ID, string Nombre, string Apellidos, global::System.Nullable<int> edad) {
            if ((ID == null)) {
        ...
        public virtual int Update(string ID, string Nombre, string Apellidos, global::System.Nullable<int> edad, string Original_ID, string Original_Nombre, string Original_Apellidos, global::System.Nullable<int> Original_edad) {
            if ((ID == null)) {
                throw new global::System.ArgumentNullException("ID");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nombre, string Apellidos, global::System.Nullable<int> edad, string Original_ID, string Original_Nombre, string Original_Apellidos, global::System.Nullable<int> Original_edad) {
            return this.Update(Original_ID, Nombre, Apellidos, edad, Original_ID, Original_Nombre, Original_Apellidos, Original_edad);
        }
    }
